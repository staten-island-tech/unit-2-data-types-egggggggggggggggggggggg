...
print("It was "+food+" day, and "+name+" was super "+adjective+" for lunch. But when she went outside to eat, a "+noun+" stole her "+food+"! "+name+" chased the "+noun+" all over school. She "+verb1+" ,"+verb2+" ,and "+verb3+"  through the playground. Then she tripped on her "+noun+" and the "+noun+" escaped! Luckily, "+name+"'s friends were willing to share their "+food+" with her. ")